...
import styles from './CharacterRecognizer.module.css';
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.buttonsContainer}>
                <div>
                    <button onClick={triggerFileInput} className={styles.uploadButton}>Upload Image</button>
                </div>
...
export default CharacterRecognizer;